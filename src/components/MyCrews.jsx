...
const MyCrews = () => {
  ...
  // console.log(data)
  const crewPostRecentsRef = useRef(null);
  const loadMore = () => {
  ...
  return (
    <CrewPosts>
      <section className="crewPostUpload">
        ...
        <div className="crewPostRecents" ref={crewPostRecentsRef} onClick={loadMore}>
...
const CrewPosts = styled.div`
 ...
 .crewPostUpload>.crewPostRecents{ width: 100%; height: 71%; display: flex;
    flex-wrap: wrap; justify-content: center;overflow-y:auto}
 ...
 .crewPostRecent>.crewPostReImg{width:100%;height:60%;border-radius:30px;overflow:hidden;background-color:#eeeeee;}
  ...
  .crewPersonMax>.crewPerson>.maxPeople{width:100%;display:flex;align-items:center;font-size:12px; }
