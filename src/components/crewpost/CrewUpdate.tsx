...
import { useUpdateCrewMutation } from '../../api/CrewApiForm';
import ReactDaumPost from 'react-daumpost-hook';

import { RxTriangleDown, RxTriangleUp } from 'react-icons/rx';
import { useNavigate } from 'react-router-dom';
import { CrewButtons, CrewContent, CrewDates, CrewFormContents, CrewLocation, CrewName, CrewTimes, CrewTitle, CrewTotalMembers, CrewUpdates } from './CrewUpdate.style';
...
const CrewUpdate:React.FC = () => {
  ...
  const { mutate } = useUpdateCrewMutation();
...
const [crew, setCrew] = useState<Crew>( {
  ...
  return (
    ...
    <CrewUpdates onSubmit={onCrewUpload}>
